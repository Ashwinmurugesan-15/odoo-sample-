...
# Script to force update the 'auth_signup.set_password_email' template
# bypassing the noupdate flag in XML

template = env.ref('auth_signup.set_password_email')
print(f"Current Template: {template.name}")

# Define the Clean HTML UNCONDITIONALLY
clean_html = """<table border="0" cellpadding="0" cellspacing="0" style="padding-top: 16px; background-color: #FFFFFF; font-family:Verdana, Arial,sans-serif; color: #454748; width: 100%; border-collapse:separate;"><tr><td align="center">
    ...
    <tr>
        <td align="center" style="min-width: 590px;">
            <table border="0" cellpadding="0" cellspacing="0" width="590" style="min-width: 590px; background-color: white; padding: 0px 8px 0px 8px; border-collapse:separate;">
                <tr><td valign="middle">
                    <span style="font-size: 10px;">Welcome to GuhaTek</span><br/>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="590" style="min-width: 590px; background-color: white; padding: 0px 8px 0px 8px; border-collapse:separate;">
                <tr><td valign="top" style="font-size: 13px;">
                    <div>
                        ...
                        You have been invited by <t t-out="object.create_uid.name or ''">OdooBot</t> of <t t-out="object.company_id.name or ''">YourCompany</t> to connect on GuhaTek.
                        ...
                        Your GuhaTek domain is: <b><a t-att-href='website_url' t-out="website_url or ''">http://yourcompany.odoo.com</a></b><br />
...
template.write({'body_html': clean_html})
env.cr.commit()
print("SUCCESS: Template body updated successfully.")
